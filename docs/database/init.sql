...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    category_id UUID REFERENCES categories(id), -- Usually null for TRANSFER
...
CREATE TABLE IF NOT EXISTS budgets (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    family_id UUID REFERENCES families(id),
    category_id UUID REFERENCES categories(id), -- Null for total family budget
...
CREATE INDEX idx_transactions_family_occurred ON transactions(family_id, occurred_at);
